...
import { useCreateProjectMutation, useGetCategoriesQuery } from '../../_core/Slices/apiSlice';
import { useNavigate } from 'react-router-dom';
import { Button, Input, Select, Heading, Textarea } from '../../components/components.js';
        ...
        if (imageFiles.length > 0) {
            ...
            try {
                ...
                if (err.message.includes('Upload preset')) {
                    ...
                    toast.error('Error creating project: ' + (err.message || err.data?.message || err.message));
                }
            } finally {
                setUploading(false);
            }
            ...
            try {
                ...
                console.error('Create Project Error:', err);
                toast.error('Error creating project: ' + (err.data?.message || err.message));
            }
        }
    };
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                    <Button type="submit" disabled={isLoading || uploading}>
                        {(isLoading || uploading) ? 'Processing...' : 'Create Project'}
                    </Button>
